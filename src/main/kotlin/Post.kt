class Post(
    ...
    ) = Post (id, ownerId, fromId, createdBy, date, text, replyOwnerId, replyPostId, friendsOnly, comments, copyright, likes, reposts, views, postType, signerId, canPin, canDelete, canEdit, isPinned, markedAsAds, isFavorite, postponedId, postSource, geo, copyHistory)
}